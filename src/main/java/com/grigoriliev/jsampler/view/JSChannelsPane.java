...
/**
 * This class defines the skeleton of a pane containing sampler channels.
 * @author Grigor Iliev
 */
public interface JSChannelsPane<C extends JSChannel> {
	 ...
	 */
	public void addChannel(SamplerChannelModel channelModel, SessionViewConfig.ChannelConfig config);
